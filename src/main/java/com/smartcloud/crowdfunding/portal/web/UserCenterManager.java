 ...
 *
 */
@URI(description="用户中心管理",path="/portal/uc/*")
public class UserCenterManager extends WebAction{
	...
	@Action(description = "用户中心首页", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/index.jsp")) })
	public String index(){
	...
	@Action(description = "我的账户-安全设置", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/safe_setting.jsp")) })
	...
	@Action(description = "发布项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/publish_project.jsp")) })
	...
	@Action(description = "提交项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/common/message_tips.jsp")) })
	public String submitProject(Project project){
		...
		tips.setBackUrl(request.getContextPath()+"/platform/portal/uc/findMyProject.action");
	...
	@Action(description = "个人设置", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/personal_setting.jsp")) })
	...
	@Action(description = "保存个人设置", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/common/message_tips.jsp")) })
	public String savePersonalSetting(PortalUser user){
		...
		tips.setWaitSecond(3);
		tips.setBackUrl(request.getContextPath()+"/platform/portal/uc/personalSetting.action");
	...
	@Action(description = "充值记录", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/record/recharge.jsp")) })
	...
	@Action(description = "退款记录", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/record/refund.jsp")) })
	...
	@Action(description = "提现记录", responses = { @Response(name = SUCCESS,forward=@Forward(url="/portal/user/record/withdraw.jsp")) })
	...
	@Action(description = "账户信息", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/account_info.jsp")) })
	...
	@Action(description = "查询关注的项目", responses = { @Response(name = SUCCESS,forward=@Forward(url="/portal/user/project/focus_list.jsp")) })
	...
	@Action(description = "查询我发布的项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/project/myproject_list.jsp")) })
	...
	@Action(description = "查询我认购的项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/project/subscribe_list2.jsp")) })
	...
	@Action(description = "接收消息列表", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/message/receive_list.jsp")) })
	...
	@Action(description = "发送消息列表", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/user/message/send_list.jsp")) })
	...
	@Action(description = "发布项目(基本信息)", responses = { 
			@Response(name = SUCCESS, forward=@Forward(url="/portal/user/publish/first.jsp")),
	...
	@Action(description = "发布项目(股权设置)", responses = { 
			@Response(name = SUCCESS,forward=@Forward(url="/portal/user/publish/second.jsp")), 
			@Response(name=FAILURE,forward=@Forward(url="/portal/common/message_tips.jsp"))})
	...
	@Action(description = "发布项目(项目编辑)", responses = { 
			@Response(name = SUCCESS, forward=@Forward(url="/portal/user/publish/third.jsp")), 
			@Response(name=FAILURE,forward=@Forward(url="/portal/common/message_tips.jsp"))})
	...
	@Action(description = "发布项目(确认合作协议)", responses = { 
			@Response(name = SUCCESS, forward=@Forward(url="/portal/user/publish/fourth.jsp")) ,
			@Response(name=FAILURE,forward=@Forward(url="/portal/common/message_tips.jsp"))})
	...
	@Action(description = "发布项目(平台审核)", responses = { 
			@Response(name = SUCCESS, forward=@Forward(url="/portal/common/message_tips.jsp")), 
			@Response(name=FAILURE,forward=@Forward(url="/portal/common/message_tips.jsp"))})
	public String publishFifth(Project project){
		...
		if(project!=null){
			...
			tips.setBackUrl(request.getContextPath()+"/platform/portal/uc/publishFirst.action");
			tips.setWaitSecond(2);
...
//			}
	...
	@Action(description = "认购", responses = { 
			@Response(name = SUCCESS, forward=@Forward(url="/portal/main/buyinfo.jsp")),
			 @Response(name = FAILURE, forward=@Forward(url="/portal/common/message_tips.jsp"))})
	...
	@Action(description = "提交订单", responses = { 
			@Response(name = SUCCESS,forward=@Forward(url="/platform/portal/uc/findSubscribeProject.action")),
			@Response(name = FAILURE, forward=@Forward(url="/portal/common/message_tips.jsp")) })
	public String submitOrder(Long projectId,Float amounts,Integer nums){
		...
		if(b){
			...
			MessageTips tips=new MessageTips();
			tips.setMessage(message);
			tips.setBackUrl(request.getContextPath()+"/platform/portal/uc/buy.action");
			tips.setWaitSecond(3);
			response.addToRequest("tips", tips);
			return FAILURE;
		}
	...
	@Action(description = "进入合作协议确认", responses = { 
			@Response(name = SUCCESS, forward=@Forward(url="/portal/user/project/cooperation_agreement.jsp"))})
	...
	@Action(description = "进入支付", responses = { 
			@Response(name = SUCCESS, forward=@Forward(url="/portal/user/project/order_pay.jsp")) })
