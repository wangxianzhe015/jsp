...
@URI(description="项目管理",path="/portal/project/*",portal=true)
public class ProjectManager extends WebAction{
	...
	@Action(description = "进入项目列表", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/project/project_list.jsp")) })
	...
	@Action(description = "分页查询", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/project/project_list.jsp")) })
	...
	@Action(description = "进入发布项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/project/publish_project.jsp")) })
	...
	@Action(description = "进入修改项目", responses = { @Response(name = SUCCESS,forward=@Forward(url="/portal/project/update_project.jsp")) })
	...
	@Action(description = "进入修改项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/project/index.action")) })
	...
	@Action(description = "删除项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/project/index.action")) })
	...
	@Action(description = "发布项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/project/project_list.jsp")) })
