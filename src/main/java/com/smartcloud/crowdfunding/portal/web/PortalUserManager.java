...
@URI(description="用户管理",path="/portal/usermgr/*")
public class PortalUserManager extends WebAction{

	@Reference
	private PortalUserService userService;
	
	@Action(description = "用户查询", responses = { @Response(name = SUCCESS, forward=@Forward(url = "/portal/usermgr/user_list.jsp")) })
	...
	@Action(description = "分页查询", responses = { @Response(name = SUCCESS, forward=@Forward(url = "/portal/usermgr/user_list.jsp")) })
	...
	@Action(description = "打开修改页面", responses = { @Response(name = SUCCESS,forward=@Forward(url = "/portal/usermgr/update_user.jsp")) })
	...
	@Action(description = "修改用户", responses = { @Response(name = SUCCESS,forward=@Forward(url = "/portal/usermgr/index.action")) })
	...
	@Action(description = "删除用户", responses = { @Response(name = SUCCESS,alert=@Alert(url = "/portal/usermgr/index.action", message = "删除成功!")) })
	...
	@Action(description = "新增用户", responses = { @Response(name = SUCCESS,forward=@Forward(url = "/portal/usermgr/index.action")) })
	public String addUser(PortalUser user) {
		userService.addUser(user);
		return SUCCESS;
	}

	@Action(description = "打开新增页面", responses = { @Response(name = SUCCESS,forward=@Forward(url = "/portal/usermgr/add_user.jsp")) })
