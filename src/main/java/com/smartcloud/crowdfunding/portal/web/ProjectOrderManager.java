 ...
 *
 */
@URI(description="项目管理",path="/portal/projectinvest/*",portal=true)
public class ProjectOrderManager extends WebAction{
	...
	@Action(description = "进入订单列表", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/projectinvest/order_list.jsp")) })
	...
	@Action(description = "翻页", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/projectinvest/order_list.jsp")) })
	public String pageQuery(TradeOrder order,String projectName,Page page){
		return index(order,projectName,page);
	}
	
	@Action(description = "进入修改订单", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/projectinvest/order_update.jsp")) })
	...
	@Action(description = "修改订单", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/projectinvest/index.action")) })
