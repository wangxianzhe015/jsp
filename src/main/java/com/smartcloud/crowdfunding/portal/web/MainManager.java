...
@URI(description="首页管理",path="/portal/main/*",portal=true)
public class MainManager extends WebAction{
	...
	@Action(description = "首页", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/index.jsp")) })
	public String index(){
		//获取所有广告横幅
	...
	@Action(description = "查看项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/main/project_detail3.jsp")) })
	...
	@Action(description = "查看项目公示信息", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/main/project_notice_info.jsp")) })
	...
	@Action(description = "根据项目状态获取所有项目", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/main/project_list.jsp")) })
	public String query(Project project, String sort,Page page){
		projectlist(project, sort,page);
		return SUCCESS;
	}
	
	@Action(description = "关于我们", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/intro/index.jsp")) })
	...
	@Action(description = "查看系统公告内容", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/main/system_notice.jsp")) })
	...
	@Action(description = "查看新闻资讯", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/main/news_detail.jsp")) })
	...
	@Action(description = "显示所有新闻资讯", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/infor/news_list.jsp")) })
	...
	@Action(description = "显示所有平台公告", responses = { @Response(name = SUCCESS, forward=@Forward(url="/portal/infor/notice_list.jsp")) })
