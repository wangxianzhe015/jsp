 ...
 *
 */
@URI(description="项目公示管理",path="/mobile/projectnotice/*",portal=true)
public class ProjectNoticeManager extends WebAction{
	...
	@Action(description = "项目公示列表", responses = { @Response(name = SUCCESS, forward=@Forward(url="/mobile/projectnotice/projectnotice_list.jsp")) })
	...
	@Action(description = "进入添加项目公示", responses = { @Response(name = SUCCESS, forward=@Forward(url="/mobile/projectnotice/projectnotice_add.jsp")) })
	...
	@Action(description = "添加项目公示", responses = { @Response(name = SUCCESS,forward=@Forward(url="/mobile/projectnotice/index.action")) })
	public String addNotice(ProjectNotice notice){
		projectNoticeService.addProjectNotice(notice);
		return SUCCESS;
	}
	
	@Action(description = "进入更新项目公示", responses = { @Response(name = SUCCESS, forward=@Forward(url="/mobile/projectnotice/projectnotice_update.jsp")) })
	...
	@Action(description = "更新项目公示", responses = { @Response(name = SUCCESS, forward=@Forward(url="/mobile/projectnotice/index.action")) })
	public String updateNotice(ProjectNotice notice){
		this.projectNoticeService.updateProjectNotice(notice);
		return SUCCESS;
	}
	
	@Action(description = "删除项目公示", responses = { @Response(name = SUCCESS, forward=@Forward(url="/mobile/projectnotice/index.action")) })
