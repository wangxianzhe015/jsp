	...
	<div class="grid_body">
		<table class="content" border="0" width="100%">
			...
			<tbody>
				<tr>
					<td width="100%">
						<form method="post" id="action" action="<%=servletPath%>/console/schedule/updateTask.action">
							...
							<table width="100%" class="form_table">
								<tr>
									...
									<td width="30%"><input type="text" name="task.taskName" value="${task.taskName}" id="task.taskName" size="30"  maxlength="50" readonly /></td>
									<td width="20%">
											
										<input type="radio" name="task.stateful" value="false" <c:if test="${task.stateful==false}"> checked  </c:if> />无状态 
										<input type="radio" name="task.stateful" value="true" <c:if test="${task.stateful==true}"> checked  </c:if>/>有状态
									</td>
								</tr>

								<tr>
									<td class="title"><span id="captionPanel">类名</td>
									<td colspan="4"><input tye="text" name="task.className" id="task.className" value="${task.taskDetail.targetName}" size="80" /></td>
								</tr>
								<tr>
									<td class="title">方法名</td>
									<td><input type="text" id="task.methodName" name="task.methodName" value="${task.taskDetail.targetOperation}" size="30" /></td>
								...
								<tr>
									...
									<td><input type="text" id="trigger.beginTime" value="${trigger.beginTime}" name="trigger.beginTime" readOnly /></td>
									<td class="title">结束时间</td>
									<td><input type="text" id="trigger.endTime" value="${trigger.endTime }" name="trigger.endTime" readOnly />
								...
								<tr>
									...
									<td colspan="4">
											 ...
											 <input type="radio" name="trigger.triggerType" id="cronRadio" value="1"   <c:if test="${trigger.triggerType==1}"> checked </c:if> />固定时间触发
											 <input type="radio" name="trigger.triggerType" id="circleRadio" value="2" <c:if test="${trigger.triggerType==2}"> checked </c:if> />日历周期触发 
									...
									<td colspan="5">
										<table width="100%" class="form_table">
											<tr>
												...
												<td colspan="2"><input type="text" name="trigger.incrementSeconds" value="${trigger.repeatInterval/1000 }" id="trigger.incrementSeconds" maxlength="9" value="0" /> &nbsp;(单位:秒)</td>
											</tr>
											<tr>
												<td width="10%" class="title">执行次数:</td>
												<td colspan="2"><input type="text" name="trigger.repeatCount" value="${trigger.repeatCount}" id="trigger.repeatCount" maxlength="4" value="1" /> &nbsp;</td>
											</tr>
										</table>
									</td>
								</tr>
									...
									<td colspan="5">
										<table width="100%" class="form_table">
											<tr>
												...
												<td><input type="text" id="trigger.cronExpression" value="${trigger.cronExpression }" name="trigger.cronExpression" /></td>
											</tr>
										</table>
									</td>
								</tr>
