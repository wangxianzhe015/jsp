...
<html>
	...
	<body>
		<div class="grid_body">
			<form
				action="<%=servletPath %>/console/org/update.action"
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<input type="text" value="${org.orgId }" name="org.orgId"
									style="display: none;" />
							</td>
						...
						<tr>
							...
							<td>
								<input type="text" value="${org.parentOrgId }"
									name="org.parentOrgId" class="initOrgTree"
									style="display: none;" />
								<input type="text" value="" name="org.parentOrgPath"
									style="display: none;" />
								<input type="text" value="${org.parentOrgName }"
									name="org.parentOrgName" readonly="readonly" />
						...
						<tr>
							...
							<td>
								<input type="text" name="org.orgManager" class="initUserTree"
									value="${ org.orgManager}" style="display: none;" />
								<input type="text" name="managerPath" value=""
									style="display: none;" />
								<input type="text" name="org.orgManagerName" readonly="readonly"
									value="${ org.orgManagerName}" />
								<a href="javascript:void(0);" id="selectUser" class="button"
						...
						<tr>
							...
							<td>
								<input type="text" name="org.orgNo" value="${org.orgNo }"/>
						...
						<tr>
							...
							<td>
								<textarea rows="5" cols="50" name="org.orgDesc">${org.orgDesc }</textarea>
							</td>
						</tr>
