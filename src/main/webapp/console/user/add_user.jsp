...
<html>
	...
	<body>
		<div class="grid_body">
			<form action="<%=servletPath %>/console/user/addUser.action" method="post" name="data_form" id="data_form">
				<table class="content">
					<thead>
						<tr>
							<th colspan="2">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  style="display: none;" name="user.employee.employeeId"
									class="initEmployeeTree" />
								<input type="text" name="user.employee.employeeName"
									readonly="readonly" />
								<a href="javascript:void(0);" id="selectEmployee" class="button"
									data-method="singleWithCheck">选择</a>
								<span class="memo">和员工基本信息关联，若不是机构职员，则不需要选择</span>
							</td>
						...
						<tr>
							...
							<td>
								<input type="text" name="user.org.orgId" class="initOrgTree"  style="display: none;"/>
