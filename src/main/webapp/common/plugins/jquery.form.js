 ...
 */
 // 修改$.fieldValue的返回值，加上encodeURIComponent()方法
 ...
 * form. These functions are mutually exclusive. Use ajaxSubmit if you want to
 * bind your own submit handler to the form. For example,
 * 
 * $(document).ready(function() { $('#myForm').on('submit', function(e) {
 * e.preventDefault(); // <-- important $(this).ajaxSubmit({ target: '#output'
 * }); }); });
 * 
...
$.fn.ajaxSubmit = function(options) {
    ...
    var method, action, url, $form = this;//调用当前ajaxSubmit方法的form表单
    ...
    var fileInputs = $('input:file:enabled[value]', this); // [value] (issue
															// #113)
        ...
        function cb(e) {
            ...
            try {
                ...
                if (!isXml && window.opera && (doc.body === null || !doc.body.innerHTML)) {
                    ...
                    // let this fall through because server response could be an
					// empty document
...
/**
 * Clears the selected form elements. 默认不包含隐藏域
 */
