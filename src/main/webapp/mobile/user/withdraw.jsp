...
<c:set var="pageTitle" value="余额提现"></c:set>
        ...
        <form class="pd-reset">
            ...
            <div class="form-wrap bd-reset">
                <div class="row">
                    ...
                    <div class="col-xs-8">
                    	<input type="text" class="form-control transparent" value="${user.realName }" readonly>
                   	</div>
                </div>
            ...
            <div class="form-wrap bd-reset">
                <div class="row">
                    ...
                    <div class="col-xs-8"><input type="text" class="form-control transparent" value="${user.identityCard }" readonly></div>
                </div>

            </div>
            <div class="form-wrap bd-reset">
                <div class="row">
                    <div class="col-xs-4 text-right">可提现金额(元)：</div>
                    <div class="col-xs-8"><input type="text" class="form-control transparent" value="${user.accountInfo.availableAmount }" readonly></div>
                </div>

            </div>
            <div class="form-wrap bd-reset">
                <div class="row">
                    <div class="col-xs-4 text-right">提现金额(元)：</div>
                    <div class="col-xs-8"><input type="text" placeholder="请输入提现金额" class="form-control transparent"></div>
                </div>

            </div>
            <div class="form-wrap bd-reset">
                <div class="row">
                    <div class="col-xs-4 text-right">提现手续费：</div>
                    <div class="col-xs-8"><input type="text" class="form-control transparent" value="3.0 元" readonly></div>
                </div>

            </div>
            <div class="form-wrap bd-reset">
                <div class="row">
                    <div class="col-xs-4 text-right">实际到账金额(元)：</div>
                    <div class="col-xs-8"><input type="text" class="form-control transparent" readonly></div>
                </div>
