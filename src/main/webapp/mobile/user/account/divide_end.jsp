...
<c:set var="pageTitle" value="项目分红"></c:set>
...
<div>
	<ul class="log-ul">
		<li class="log-header">
		<div class="row">
			<div class="col-xs-5">分红名称</div>
			<div class="col-xs-3">分红次数</div>
			<div class="col-xs-4">分红总额 (元)</div>
		</div>
		</li>
		...
		<li class="log-item">
		<div class="row">
			<div class="col-xs-5">令狐冲东二环泰禾店</div>
			<div class="col-xs-3">3</div>
			<div class="col-xs-4">1565.2</div>
		</div>
		</li>
		<li class="log-item">
		<div class="row">
			<div class="col-xs-5">令狐冲东二环泰禾店</div>
			<div class="col-xs-3">3</div>
			<div class="col-xs-4">1254.02</div>
		</div>
		</li>
	</ul>
</div>
