							...
							<div id="Tab1">
								<div class="Menubox">
									<ul>
										...
										<li id="tab" data-url="<%=servletPath %>/portal/pay/queryRefund.action" class="hover">退款查询</li>
									</ul>
								</div>
								<div class="Contentbox">
											<form action="<%=servletPath %>/portal/pay/queryRefund.action" method="post" name="query_form" id="query_form">
												<div class="grid_body">
													<table>
														<thead>
															<tr>
												     ...
												     <c:when test="${not empty result }">
														...
														<tr>
															...
															<td>
															   ...
															   <c:if test="${result.status==4}">处理中</c:if>
															   <c:if test="${result.status==5}">退款成功</c:if>	
															   </font>					
															</td>
														</tr>	
														<tr>
