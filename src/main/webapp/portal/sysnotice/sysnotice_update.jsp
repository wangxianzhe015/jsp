...
<html>
	...
	<body>
		<div class="grid_body">
			<form action="<%=servletPath %>/portal/sysnotice/updateNotice.action" method="post" name="data_form" id="data_form">
				...
				<table class="content">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="text" name="notice.title" value="${notice.title }" size="60px"/>
							</td>
						</tr>
						<tr>
							<td class="title">
