...
<html>
	...
	<body>
		<div class="grid_body">
			<form action="<%=servletPath %>/portal/projectnotice/addNotice.action" method="post" name="data_form" id="data_form">
				<table class="content">
					<thead>
						<tr>
							<th colspan="2">
							...
							<td>
								<select name="notice.project.projectId" style="width: 400px" >
								   ...
								   <c:forEach items="${projects }" var="project">
								   		<option value="${project.projectId }">${project.projectName }(${project.projectStateName })</option>
								   </c:forEach>
								</select>
							</td>
						</tr>
