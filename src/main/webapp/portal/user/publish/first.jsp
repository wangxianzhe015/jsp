...
$(document).ready(function(){
	...
	$("#projectFounder").formValidator({onshow:" ",onfocus:"请输入项目联系人",oncorrect:" "}).inputValidator({min:1,onerror:"请输入项目联系人"});
	$("#contactPhone").formValidator({onshow:" ",onfocus:"请输入联系电话",oncorrect:" "}).inputValidator({min:1,onerror:"请输入联系电话"});

	$("#address").formValidator({onshow:" ",onfocus:"请输入店铺地址",oncorrect:" "}).inputValidator({min:1,onerror:"请输入店铺地址"});
	$("#projectProfile").formValidator({onshow:" ",oncorrect:" "}).inputValidator({min:1,max:128,onerror:"内容不能超过100个汉字"});
		...
		<div class="row mt-20">
			...
			<div class="col-23 bg_white">
                ...
                <form id="form_publish_first" name="form_publish_first" method="post" action="<%=servletPath%>/portal/uc/publishSecond.action">
                    ...
                    <label for="">融资开始 :</label><input type="text" id="raiseBeginDate" name="project.raiseBeginDate" readonly="readonly" value='<fmt:formatDate value="${project.raiseBeginDate}" pattern="yyyy-MM-dd"/>' class="iup"/> <br/>
                    <label for="">融资截止 :</label><input type="text" id="raiseEndDate" name="project.raiseEndDate" readonly="readonly" value='<fmt:formatDate value="${project.raiseEndDate}" pattern="yyyy-MM-dd"/>' class="iup"/> <br/>
                    ...
                    <br>
                    <label for="">联系人&nbsp;&nbsp;&nbsp;&nbsp;:</label>
						<input type="text" id="projectFounder" name="project.projectFounder" class="iup"  value="${project.projectFounder }"/><div id="projectFounderTip" style="display:inline-block"></div>
					<br>        
                    <label for="">联系电话:</label>
						<input type="text" id="contactPhone" name="project.contactPhone" class="iup"  value="${project.contactPhone}"/><div id="contactPhoneTip" style="display:inline-block"></div>
					<br>  					            
					...
					<div id="projectProfileTip"  style="display:inline-block"></div>
					<br> 
