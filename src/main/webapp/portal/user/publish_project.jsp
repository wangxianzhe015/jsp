...
$(document).ready(function(){
			...
			$("#projectProfile").formValidator({onshow:" ",onfocus:"请输入项目简介",oncorrect:"输入正确"});
			$("#address").formValidator({onshow:" ",onfocus:"请输入店铺地址",oncorrect:"输入正确"}).regexValidator({regexp:"projectname",datatype:"enum",onerror:"请输入2-10位汉字数字或字母"});
        ...
        <div class="col-23 bg_white">
            <div class="pos_jindu">
	            <div class="clear  user_tit_box mt-20">
	                 <div class="fl user_tit font-wet">发布项目</div> 
	            </div>
                <p></p>
                <h3>基本信息</h3>
                <form id="form_publish_first" method="post" action="<%=servletPath%>/portal/uc/submitProject.action">
                    ...
                    <label for="">开始日期 :</label><input type="text" id="raiseBeginDate" name="project.raiseBeginDate" value="${project.raiseBeginDate}" class="iup" readonly="readonly"/> <div id="raiseBeginDateTip"  style="display:inline-block"></div><br/>
                    <label for="">结束日期 :</label><input type="text" id="raiseEndDate" name="project.raiseEndDate" value="${project.raiseEndDate}" class="iup" readonly="readonly"/> <div id="raiseEndDateTip"  style="display:inline-block"></div><br/>
                    ...
                    <input name="project.address" id="address" class="iup" value="" style="width:230px"/>
                    ...
                    <div class="next_step" style="width: 150px;margin: 20px auto">
                        <button id="button_next" class="">提交审核</button>
                    </div>
                	                    
                </form>
            </div>
        </div>
        <%@include file="./publish/finance_agreement.jsp" %>
