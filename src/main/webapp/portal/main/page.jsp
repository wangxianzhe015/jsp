...
<form action="<%=servletPath%>/portal/main/projectlist.action" method="post" name="page_form" id="page_form">
	...
	<div class="grid_foot">
		...
		<div class="foot_right">
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="javascript:firstPage('<%=servletPath %>/portal/main/projectlist.action', null, null);">首页</a>
				</c:otherwise>
			</c:choose>
			<c:choose>
				<c:when test="${page.first==true}">
				...
				<c:otherwise>
					<a href="javascript:prevPage('<%=servletPath %>/portal/main/projectlist.action', null, 'page_form');">上一页</a>
				</c:otherwise>
			</c:choose>
			<c:choose>
				...
				<c:otherwise>
					<a href="javascript:nextPage('<%=servletPath %>/portal/main/projectlist.action', null, 'page_form');">下一页</a>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="javascript:lastPage('<%=servletPath %>/portal/main/projectlist.action', null, 'page_form');">末页</a>
				</c:otherwise>
			</c:choose>
		</div>
	</div>
